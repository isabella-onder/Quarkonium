...
t_av_lepton = 1/(cex.lepton_positron_percent*cex.total_width) * sec * norm
print(t_av_lepton)
t_av_threeg = 1/(cex.three_gluons_percent*cex.total_width) * sec * norm
t_av_onegtwog = 1/(cex.one_g_two_g_percent*cex.total_width) * sec * norm
t_av_hyperfine = 1/(cex.hyperfine_percent*cex.total_width) *sec * norm
t_av_three_photons = 1/(cex.three_photons_percent*cex.total_width)*sec*norm
...
#animation.Animation.save(ani,'animations/formative_charm_exp.gif')
